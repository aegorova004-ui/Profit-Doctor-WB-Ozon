...
Первый шаг выполнен: добавлены negative-detection для WB XLSX-каталога, synthetic CSV fixture по структуре публичного WB CSV и preview-адаптер для товарных строк CSV. Следующий шаг — найти или получить CSV/XLSX с реальными товарными продажами, возвратами и сервисными удержаниями в одном периоде, чтобы проверить правила знаков и распределение общих расходов.
